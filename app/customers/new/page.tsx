          ...
          <div style={{ border: '1px solid #edf0f3', borderRadius: 16, padding: 18 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: 14, paddingTop: 14, borderTop: '1px solid #f2f4f6' }}>
              <div>
                ...
                <div style={{ fontSize: 15, fontWeight: 600, color: '#3b4954', fontFamily: "'IBM Plex Sans', sans-serif" }}>0</div>
              </div>
